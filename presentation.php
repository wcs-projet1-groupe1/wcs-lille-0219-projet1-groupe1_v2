...
<nav class="position-fixed naveura col-2">
  ...
  <div class="content">
    ...
    <section id="Description">
      <h3 style="padding-top: 180px; margin-top: -180px;">Description</h3>
        ...
        <p>Born in 2009 in Lille, <b>Euratechnologies</b> is the center of excellence and digital innovation of French Tech. First incubator and accelerator of startups in France and ranked in the top 3 in Europe, Euratechnologies accompanies the development of all its companies. From support to international deployment, it contributes to its success. Let’s talk about numbers, Euratechnologies has :</p>
          <ul id="squarelist">
            <li>more than 300 companies</li>
            <li>200 startups</li>
            <li>more than 4000 employees</li>
            <li>300 supported projects</li>
    ...
    <section>
        <div class="card">
          <h5 class="card-header card-euratech">Start by Euratech</h5>
          <div class="card-body">
    ...
    <section>
        <div class="card">
          <h5 class="card-header card-euratech">Scale by Euratech</h5>
          <div class="card-body">
            <p class="card-text">In business support, Euratechnologies has created the <i>Scale by EuraTech</i> acceleration program. It consists of a 9-month program divided into two parts :
              <ul id="squarelist">
                <li>3 months on the strategy and structure of the company</li>
                <li>6 months on the "go-to-market" to work sales, negotiation, marketing, …</li>
              </ul>
    ...
    <section>
        <div class="card">
          <h5 class="card-header card-euratech">Grow by Euratech</h5>
          <div class="card-body">
    ...
    <section id="Opportunities">
        <h3 style="padding-top: 80px; margin-top: -80px;">Opportunities</h3>
          <br>
            <div class="card">
              <div class="card-body">
    ...
    <section>
        <div class="card">
            <div class="card-body">
              <p class="card-text">With many opportunities and an ideal setting, <b>Euratechnologies</b> is a place of excellence and innovation essential to Lille's metropolis. If you are looking for training, a job or even an internship, you can find everything you need.</p>
              <div class="float-left">
                  <p>Find the Euratechnologies website : <a href="https://en.euratechnologies.com/" target="_blank"><img src="https://i.postimg.cc/L4Nxmy4V/mn-NAb-Mb-N-400x400.jpg" alt= "logo"/></a></p>
                </div>
            </div>
          </div>
    </section>
